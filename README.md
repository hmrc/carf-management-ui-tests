# carf-management-ui-tests

`carf-management-frontend` UI journey tests.

## Pre-requisites
The relevant microservices should be up and running for the management ui journey tests
...
Start `carf-management-frontend` services as follows:
